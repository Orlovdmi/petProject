<div class="mt-8">
    <a href="{{ route('movies.show', $movie['id']) }}">
        <img src="{{ $movie['poster_path'] }}" alt="{{$movie['id']}}" class="hover:opacity-75 transition ease-in-out duration-1">
    </a>
    <div class="mt-2">
        <div class="text-lg mt-2 hover:text-gray-300"><a href="{{ route('movies.show', $movie['id']) }}">{{ $movie['title'] }}</a></div>
